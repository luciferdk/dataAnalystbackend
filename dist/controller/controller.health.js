...
async function getHealthData(req, res) {
    try {
        ...
        // 2) Postgres query
        const totalResult = await database_1.default.query("SELECT COUNT(*)::bigint AS count FROM health_data");
      ...
      `, [limit, offset]);
        ...
        // 3) Set Redis cache
        await (0, redisCache_1.setCache)(cacheKey, responsePayload, 300); // 5 min
